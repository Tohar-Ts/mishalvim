...
public class ViewOldFormActivity extends AppCompatActivity implements View.OnClickListener,
        openFormWarningDialog.openFormWarningListener, openFormCancelDialog.openFormCancelListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        clickedFormId = getIntent().getStringExtra("CLICKED_FORM_ID");
    ...
    private void updateEditMode() {
        ...
        if (globalInstance.getType().equals(FirebaseStrings.guideStr()))
            ...
            editBTM.setVisibility(View.VISIBLE);
