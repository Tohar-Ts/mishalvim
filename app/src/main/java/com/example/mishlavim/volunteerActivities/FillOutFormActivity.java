...
public class FillOutFormActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        progressAnimator = ObjectAnimator.ofInt(progressBar, "progress", 0, 10);
    }
    ...
    private void nextBtnOn() {
            ...
            questionNumTextView.setText("@string/question" + numOfCurrentQuestion);
...
//        progressBar = findViewById(R.id.questionProgressBar);
//        progressAnimator = ObjectAnimator.ofInt(progressBar, "progress", numOfCurrentQuestion, numOfQuestion);
